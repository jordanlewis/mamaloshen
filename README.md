...
get the app created:
    ...
    $ heroku apps:create mamaloshen
    Creating mamaloshen... done, stack is cedar
    http://mamaloshen.herokuapp.com/ | git@heroku.com:mamaloshen.git
...
You can deploy the skeleton project immediately:
    ...
    [...]
    -----> Launching... done, v3
           http://mamaloshen.herokuapp.com deployed to Heroku

    To git@heroku.com:mamaloshen.git
     * [new branch]      master -> master

It's live! Hit it with `curl`:

    $ curl http://mamaloshen.herokuap.com
    ["Hello" :from Heroku]
